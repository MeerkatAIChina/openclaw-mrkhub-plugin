...
export const DEFAULT_SKILLS_SUBPATH = "manufacturing-ai-efficiency-pro";
...
export function resolveConfig(
  ...
  return {
    ...
    installDir:
      typeof raw.installDir === "string" ? raw.installDir : undefined,
    githubToken:
      typeof raw.githubToken === "string"
        ? raw.githubToken
        : process.env.GITHUB_TOKEN,
    defaultRef:
      typeof raw.defaultRef === "string" ? raw.defaultRef : DEFAULT_REF,
  };
}
